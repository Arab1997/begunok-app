...
import kotlinx.android.synthetic.main.screen_login.email
import kotlinx.android.synthetic.main.screen_login.passw

class LoginScreen : BaseFragment(R.layout.screen_login) {

    override fun initialize() {
        email.addTextChangedListener(TextObservable(enter) {})
        passw.addTextChangedListener(TextObservable(enter) {})
